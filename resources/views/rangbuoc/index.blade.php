...
<dir class="row" style="padding: 0;margin: 0">
	...
	<dir class="col-md-9" style="margin: 0;padding: 2px">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<select class="form-control input-sm" id="chonbuoitietnghilop">
								...
								<option value="0">Buổi sáng
								</option>
								<option value="1">Buổi chiều
								</option>
							</select>
						</div>
						<div class="col-md-2">
						...
						<div class="col-md-3">
							<button type="button" class="btn mr-1 mb-1 btn-info btn-sm" id="capnhattietnghilop">Cập
								nhật</button>
						</div>
					</div>
				...
				<div class="card-body">
					<div class="row">
						<!-- <div class="col-md-2">
							<fieldset class="radio">
								<label>
									<input type="radio" name="radio" value="" id="rangbuoctietcodinhtiettrong">
									Tiết trống
								</label>
							</fieldset>						
						</div> -->
						<!-- <div class="col-md-2">
							<fieldset class="radio">
								<label>
									<input type="radio" name="radio" value="" id="rangbuoctietcodinhtiethoc">
									Tiết học
								</label>
							</fieldset>						
						</div> -->
					...
					<div class="row">
						<div class="col-md-2">
							<button type="button" class="btn mr-1 mb-1 btn-info btn-sm" id="btnthemmoitiethoc">Thêm
								mới</button>
							<button type="button" class="btn mr-1 mb-1 btn-info btn-sm" id="btnthemmoitiettrong">Thêm
								mới</button>
						</div>
					</div>

					<!-- form thêm mới ràng buộc tiết cố định loại tiết trống -->
					<!-- <form class="form" id="formthemmoirangbuoctietcodinhtiettrong" style="display: none;">
						<div class="form-body">
							<h6 class="form-section">Thêm & sửa ràng buộc tiết cố định tiết trống</h6>
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label for="projectinput1">Thứ</label>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="projectinput2">Tiết thứ</label>
										<select class="select2 form-control">
											<option value="CA" />California
											<option value="NV" />Nevada
											<option value="OR" />Oregon
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="projectinput3">Mức ràng buộc</label>
										<select class="select2 form-control">
											<option value="CA" />California
											<option value="NV" />Nevada
											<option value="OR" />Oregon
						...
						<div class="form-actions right">
							<button type="button" class="btn mr-1 mb-1 btn-info btn-sm" id="btnthemtiettrong" >Lưu</button>
							<button type="button" class="btn mr-1 mb-1 btn-info btn-sm" id="btncapnhattiettrong" hidden>Lưu</button>		
							<button type="button" class="btn mr-1 mb-1 btn-danger btn-sm" id="btnhuytiettrong" >Hủy</button>
						</div>						
					</form> -->
		...
		<div class="card" id="formdangkybuoitietnghicuagv" style="display: none">
			...
			<div class="card-content collapse show">
				<div class="card-body">
					<button type="button" class="btn mr-1 mb-1 btn-danger btn-sm" id="dkbuoinghiall">Đăng ký buổi
						nghỉ</button>
					<button type="button" class="btn mr-1 mb-1 btn-success btn-sm" id="dktietnghiall">Đăng ký tiết
						nghỉ</button>
		...
		<!-- chọn tiêt -->
		<div class="modal fade text-left show" id="chontiet" tabindex="-1" role="dialog"
		...
		<!-- chọn lop sang -->
		<div class="modal fade text-left show" id="chonlopsang" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel18">
		...
		<!-- chọn lop chieu -->
		<div class="modal fade text-left show" id="chonlopchieu" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel18">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
		...
		<!-- chọn môn -->
		<div class="modal fade text-left show" id="chonmontranh" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel18">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
			...
			<div class="card-content collapse show">
				<div class="card-body">
					...
					<div class="form-group row">
						<div class="col-md-2">
							<button type="button" class="btn mr-1 mb-1 btn-info btn-sm" id="updatecaptiet">Cập
								nhật</button>
						</div>
						<label class="col-md-10 label-control" style="text-align:left;color: #f44336;">Lưu ý: Mức ràng
							buộc càng cao thì ràng buộc càng được ưu tiên khi xếp TKB</label>
					</div>
					...
					<dir class="row" style="padding: 0;margin: 0">
						<section class="col-md-12 col-xs-12">
							<section style="margin-top: 10px;">
								...
								<p style="font-weight: bold; color:red;"><i style="cursor: pointer;"
										id="showLopApDungNgay" class="fas fa-arrow-circle-right" aria-hidden="true"></i>
									Chọn khối, lớp áp dụng:<span id="chonkhoilopNgay"></span></p>
							...
							<section>
								<section>
									...
									<span style="color: brown"><b>Lưu ý:</b> Với môn học có tiết đôi (cặp tiết buộc phải
										liền nhau), nếu các tiết còn lại không
									...
									<table class="table table-bordered table-light">
										<thead class="thead-default">
											<tr>
												...
												<th id="tongsotiet">Số tiết tối đa của môn học trong ngày (tổng cả sáng
													và chiều)
												</th>
											</tr>
											<tr id="monhoc">
					...
					<dir class="row" style="padding: 0;margin: 0">
						<section class="col-md-12 col-xs-12">
							...
							<section style="margin-top: 10px;">
								...
								<p style="font-weight: bold; color:red;"><i style="cursor: pointer;"
										id="showLopApDungBuoi" class="fas fa-arrow-circle-right" aria-hidden="true"></i>
									Chọn khối, lớp áp dụng:<span id="chonkhoilop"></span></p>
								<section id="tableChuaphancongBuoi" class="hidden"
									...
									<table class="table table-bordered table-light">
										<thead class="thead-default">
											<tr>
												<th rowspan="2">STT</th>
												<th rowspan="2">Tên lớp học</th>
												<th id="tongsotietBuoi">Số tiết tối đa của môn học trong ngày (tổng cả
													sáng và chiều)
												</th>
		...
		<!-- modal thêm tiết học -->
		<div class="modal fade text-left" id="modaltiethoc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16"
		...
		<!-- modal sửa tiết học -->
		<div class="modal fade text-left" id="modalsuatiethoc" tabindex="-1" role="dialog"
		...
		<div class="modal fade text-left" id="modaldangkytietbuocphaicogv" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel15" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document" style="min-width: auto;max-width: fit-content;">
				<div class="modal-content">
					<div class="modal-header bg-success white">
						<h4 class="modal-title white" id="myModalLabel15">Đăng ký tiết buộc phải có cho GV <b><span
									id="idbidanhgv" style="color: yellow;"></span></b></h4>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"
							id="btndongdangkytietbuocphaicogv">
							<span aria-hidden="true">×</span>
						</button>
					</div>
					<div class="modal-body">
		...
		<div class="modal fade text-left" id="modaldangkybuoinghicuagv" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel15" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header bg-success white">
						<h4 class="modal-title white" id="myModalLabel15">Đăng ký buổi nghỉ cho GV <b><span
									id="idbidanhgv2" style="color: yellow;"></span></b></h4>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"
							id="btndongdangkybuoinghicuagv">
							<span aria-hidden="true">×</span>
						</button>
					</div>
					<div class="modal-body">
		...
		<div class="modal fade text-left" id="modaldangkytietnghicuagv" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel15" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document" style="min-width: auto;max-width: fit-content;">
				<div class="modal-content">
					<div class="modal-header bg-success white">
						<h4 class="modal-title white" id="myModalLabel15">Đăng ký tiết nghỉ cho GV <b><span
									id="idbidanhgv1" style="color: yellow;"></span></b></h4>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"
							id="btndongdangkytietnghicuagv">
							<span aria-hidden="true">×</span>
						</button>
					</div>
					<div class="modal-body">
								...
								<div class="flex-container" style=" display: flex;">
									<div>
										<table class="classTableEdit table table-bordered table-striped table-hover"
											id="tablechontietdangkynghi" style="width: 98%;">
											<thead class="thead-inverse">
												<tr>
		...
		<div class="modal fade text-left" id="modaldangkybuoinghiall" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel15" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header bg-success white">
					...
					<div class="modal-footer">
						<button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal"
							id="btnhuybuoinghiall">Huỷ</button>
		...
		<div class="modal fade text-left" id="modaldangkytietnghiall" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel15" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header bg-success white">
					...
					<div class="modal-footer">
						<button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal"
							id="btnhuytietnghiall">Huỷ</button>
