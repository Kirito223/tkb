                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                            ...
                            <span class="badge badge-pill badge-default badge-danger badge-default badge-up">{{ $thongbaocount }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0"><span class="grey darken-2">Thông báo</span></h6>

                                <span class="notification-tag badge badge-default badge-danger float-right m-0">{{ $thongbaocount }}</span>
                            </li>
                                ...
                                <a href="thongbaotruong">
                                    <div class="media">
                                        <div class="media-body">
                                            ...
                                            <small>
                                                <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">{{$row->ngaytao}}</time>
                                            </small>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center" href="thongbaotruong">Xem tất cả thông báo</a>
                            </li>
                        </ul>
                    </li>
                   @endif
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                            <i class="ficon ft-bell"></i>
                            <span class="badge badge-pill badge-default badge-danger badge-default badge-up">{{ $baocaocount }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0"><span class="grey darken-2">Báo Cáo</span></h6>

                                <span class="notification-tag badge badge-default badge-danger float-right m-0">{{ $baocaocount }}</span>
                            </li>
                            <li class="scrollable-container media-list w-100">
