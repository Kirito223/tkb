				...
				<div class="card" id="cardxeptkbtruong" style="display: none;">
					<div class="card-header" style="padding: 10px">
						...
						<div class="heading-elements" style="top: 10px">
							<ul class="list-inline mb-0">
								<li><a data-action="collapse"><i class="ft-minus"></i></a></li>
								<li><a data-action="expand" id="phongtothunhotkbtruong"><i class="ft-maximize"></i></a></li>
							</ul>
						</div>
					</div>
					<div class="card-content collpase show">
									...
									<section>
										<div class="container">
											...
											<div id="bangsangchieu">
												<table id="tablexemtkbtruong" class="table table-striped table-bordered dataex-key-basic table-responsive display nowrap" style="overflow:auto; overflow-y: scroll; height: 600px;width: 100%;">
													<thead class="thead-inverse" style="background-color: #28386c;color: white;">
...
<script type="text/javascript" src="js/xemtkb/xemtkb.js"></script>
