...
function createtkbtong() {
    var data = axios.get('getdanhsachlophoc').then(function(response) {
		...
		thead.setAttribute("style", "background-color:#28386c;color:#fff");
        ...
        for (var z = 0; z < 60; z++) {
         ...
         for (var ii = 0; ii < 56; ii++) {
            if (ii == 0) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 2 Sáng ");
                for (var j = 1; j < 6; j++) {
                    if (j == 1) {
                        $('#tkb tr:eq(0) td:eq(1)').attr('class', 'sticky-col second-col').html(j);
                    } else {
                        $('#tkb tr:eq(' + (j - 1) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(j);
                    }

                }
            } else if (ii == 5) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 2 chiều ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(5) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (4 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 10) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 3 sáng ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(10) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (9 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 15) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 3 chiều ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(15) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (14 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 20) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 4 sáng ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(20) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (19 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 25) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 4 chiều ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(25) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (24 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 30) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 5 sáng ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(30) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (29 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 35) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 5 chiều ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(35) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (34 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 40) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 6 sáng ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(40) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (39 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 45) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 6 chiều ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(45) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (44 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 50) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 7 sáng ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(50) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (49 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').html(q);
                    }
                }
            } else if (ii == 55) {
                $('#tkb tr:eq(' + ii + ') td:eq(0)').attr('class', 'sticky-col first-col').attr('rowspan', 5).html("Thứ 7 chiều ");
                for (var q = 1; q < 6; q++) {
                    if (q == 1) {
                        $('#tkb tr:eq(55) td:eq(1)').attr('class', 'sticky-col second-col').html(q);
                    } else {
                        $('#tkb tr:eq(' + (54 + q) + ') td:eq(0)').attr('class', 'sticky-col second-col').attr('draggable', 'true').html(q);
                    }
                }
            }
        }
...
function hienThithoigian() {
    ...
    let phut = 0;
    let giay = 0;
    thoigianchay = setInterval(function() {
        giay++;
        if (giay == 60) {
            phut++;
            giay = 0;
        ...
        lblThoigian.textContent = `${gio}:${phut < 10 ? "0" + phut : phut}:${
            giay < 10 ? "0" + giay : giay
        }`;
    }, 1000);
}
...
function showtkb(locdatasort)
{
    ...
    if (idphonghoc != null) {
        let dataphonghoc = thoikhoabieuphonghoc(idphonghoc, locdatasort);
    }
        ...
        for (var j = 0; j < 60; j++) {
            ...
            lucky2t1.filter(function(number) {
                ...
                if (j == 0 && malop == lop2t1 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(0) td:eq(' + (cell) + ')').html(thu2t1).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t1.filter(function(number) {
                ...
                if (j == 10 && malop == lop3t1 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(10) td:eq(' + (cell) + ')').html(thu3t1).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t1.filter(function(number) {
                ...
                if (j == 20 && malop == lop4t1 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(20) td:eq(' + (cell) + ')').html(thu4t1).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t1.filter(function(number) {
                ...
                if (j == 30 && malop == lop5t1 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(30) td:eq(' + (cell) + ')').html(thu5t1).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t1.filter(function(number) {
                ...
                if (j == 40 && malop == lop6t1 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(40) td:eq(' + (cell) + ')').html(thu6t1).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t1.filter(function(number) {
                ...
                if (j == 50 && malop == lop7t1 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(50) td:eq(' + (cell) + ')').html(thu7t1).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t2.filter(function(number) {
                ...
                if (j == 1 && malop == lop2t2 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(1) td:eq(' + (cell - 1) + ')').html(thu2t2).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t2.filter(function(number) {
                ...
                if (j == 11 && malop == lop3t2 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(11) td:eq(' + (cell - 1) + ')').html(thu3t2).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t2.filter(function(number) {
                ...
                if (j == 21 && malop == lop4t2 && cell == (stt + 1)) {
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(21) td:eq(' + (cell - 1) + ')').html(thu4t2).attr('style','border: 1px solid #ddd;background-color: red');
                    }
                    else
                    {
            ...
            lucky5t2.filter(function(number) {
                ...
                if (j == 31 && malop == lop5t2 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(31) td:eq(' + (cell - 1) + ')').html(thu5t2).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t2.filter(function(number) {
                ...
                if (j == 41 && malop == lop6t2 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(41) td:eq(' + (cell - 1) + ')').html(thu6t2).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t2.filter(function(number) {
                ...
                if (j == 51 && malop == lop7t2 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(51) td:eq(' + (cell - 1) + ')').html(thu7t2).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t3.filter(function(number) {
                ...
                if (j == 2 && malop == lop2t3 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(2) td:eq(' + (cell - 1) + ')').html(thu2t3).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t3.filter(function(number) {
                ...
                if (j == 12 && malop == lop3t3 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(12) td:eq(' + (cell - 1) + ')').html(thu3t3).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t3.filter(function(number) {
                ...
                if (j == 22 && malop == lop4t3 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(22) td:eq(' + (cell - 1) + ')').html(thu4t3).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t3.filter(function(number) {
                ...
                if (j == 32 && malop == lop5t3 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(32) td:eq(' + (cell - 1) + ')').html(thu5t3).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t3.filter(function(number) {
                ...
                if (j == 42 && malop == lop6t3 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(42) td:eq(' + (cell - 1) + ')').html(thu6t3).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t3.filter(function(number) {
                ...
                if (j == 52 && malop == lop7t3 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(52) td:eq(' + (cell - 1) + ')').html(thu7t3).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t4.filter(function(number) {
                ...
                if (j == 3 && malop == lop2t4 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(3) td:eq(' + (cell - 1) + ')').html(thu2t4).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t4.filter(function(number) {
                ...
                if (j == 13 && malop == lop3t4 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                          $('#tkb tr:eq(13) td:eq(' + (cell - 1) + ')').html(thu3t4).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t4.filter(function(number) {
                ...
                if (j == 23 && malop == lop4t4 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                          $('#tkb tr:eq(23) td:eq(' + (cell - 1) + ')').html(thu4t4).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t4.filter(function(number) {
                ...
                if (j == 33 && malop == lop5t4 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                          $('#tkb tr:eq(33) td:eq(' + (cell - 1) + ')').html(thu5t4).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t4.filter(function(number) {
                ...
                if (j == 43 && malop == lop6t4 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                           $('#tkb tr:eq(43) td:eq(' + (cell - 1) + ')').html(thu6t4).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t4.filter(function(number) {
                ...
                if (j == 53 && malop == lop7t4 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                          $('#tkb tr:eq(53) td:eq(' + (cell - 1) + ')').html(thu7t4).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t5.filter(function(number) {
                ...
                if (j == 4 && malop == lop2t5 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(4) td:eq(' + (cell - 1) + ')').html(thu2t5).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t5.filter(function(number) {
                ...
                if (j == 14 && malop == lop3t5 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(14) td:eq(' + (cell - 1) + ')').html(thu3t5).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t5.filter(function(number) {
                ...
                if (j == 24 && malop == lop4t5 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(24) td:eq(' + (cell - 1) + ')').html(thu4t5).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t5.filter(function(number) {
                ...
                if (j == 34 && malop == lop5t5 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(34) td:eq(' + (cell - 1) + ')').html(thu5t5).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t5.filter(function(number) {
                ...
                if (j == 44 && malop == lop6t5 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(44) td:eq(' + (cell - 1) + ')').html(thu6t5).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t5.filter(function(number) {
                ...
                if (j == 54 && malop == lop7t5 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(54) td:eq(' + (cell - 1) + ')').html(thu7t5).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t6.filter(function(number) {
                ...
                if (j == 5 && malop == lop2t6 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                         $('#tkb tr:eq(5) td:eq(' + (cell) + ')').html(thu2t6).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t6.filter(function(number) {
                ...
                if (j == 15 && malop == lop3t6 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(15) td:eq(' + (cell) + ')').html(thu3t6).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t6.filter(function(number) {
                ...
                if (j == 25 && malop == lop4t6 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(25) td:eq(' + (cell) + ')').html(thu4t6).attr('style','border: 1px solid #ddd;background-color: red');
                        
                    }
                    else
                    {
                         $('#tkb tr:eq(25) td:eq(' + (cell) + ')').html(thu4t6).attr('style','border: 1px solid #ddd;');
                    }
                    let cells = cell-1;
                    let rows = j;
            ...
            lucky5t6.filter(function(number) {
                ...
                if (j == 35 && malop == lop5t6 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(35) td:eq(' + (cell) + ')').html(thu5t6).attr('style','border: 1px solid #ddd;background-color: red');
                        
                    }
                    else
                    {
                         $('#tkb tr:eq(35) td:eq(' + (cell) + ')').html(thu5t6).attr('style','border: 1px solid #ddd;');
                    }
                    let cells = cell-1;
                    let rows = j;
            ...
            lucky6t6.filter(function(number) {
                ...
                if (j == 45 && malop == lop6t6 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(45) td:eq(' + (cell) + ')').html(thu6t6).attr('style','border: 1px solid #ddd;background-color: red');
                        
                    }
                    else
                    {
                         $('#tkb tr:eq(45) td:eq(' + (cell) + ')').html(thu6t6).attr('style','border: 1px solid #ddd;');
                    }
                    let cells = cell-1;
                    let rows = j;
            ...
            lucky7t6.filter(function(number) {
                ...
                if (j == 55 && malop == lop7t6 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(55) td:eq(' + (cell) + ')').html(thu7t6).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t7.filter(function(number) {
                ...
                if (j == 6 && malop == lop2t7 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(6) td:eq(' + (cell-1) + ')').html(thu2t7).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t7.filter(function(number) {
                ...
                if (j == 16 && malop == lop3t7 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(16) td:eq(' + (cell-1) + ')').html(thu3t7).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t7.filter(function(number) {
                ...
                if (j == 26 && malop == lop4t7 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(26) td:eq(' + (cell-1) + ')').html(thu4t7).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t7.filter(function(number) {
                ...
                if (j == 36 && malop == lop5t7 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(36) td:eq(' + (cell-1) + ')').html(thu5t7).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t7.filter(function(number) {
                ...
                if (j == 46 && malop == lop6t7 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(46) td:eq(' + (cell-1) + ')').html(thu6t7).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t7.filter(function(number) {
                ...
                if (j == 56 && malop == lop7t7 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(56) td:eq(' + (cell-1) + ')').html(thu7t7).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t8.filter(function(number) {
                ...
                if (j == 7 && malop == lop2t8 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(7) td:eq(' + (cell-1) + ')').html(thu2t8).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t8.filter(function(number) {
                ...
                if (j == 17 && malop == lop3t8 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(17) td:eq(' + (cell-1) + ')').html(thu3t8).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t8.filter(function(number) {
                ...
                if (j == 27 && malop == lop4t8 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(27) td:eq(' + (cell-1) + ')').html(thu4t8).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t8.filter(function(number) {
                ...
                if (j == 37 && malop == lop5t8 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(37) td:eq(' + (cell-1) + ')').html(thu5t8).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t8.filter(function(number) {
                ...
                if (j == 47 && malop == lop6t8 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(47) td:eq(' + (cell-1) + ')').html(thu6t8).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t8.filter(function(number) {
                ...
                if (j == 57 && malop == lop7t8 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(57) td:eq(' + (cell-1) + ')').html(thu7t8).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t9.filter(function(number) {
                ...
                if (j == 8 && malop == lop2t9 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(8) td:eq(' + (cell-1) + ')').html(thu2t9).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t9.filter(function(number) {
                ...
                if (j == 18 && malop == lop3t9 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(18) td:eq(' + (cell-1) + ')').html(thu3t9).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t9.filter(function(number) {
                ...
                if (j == 28 && malop == lop4t9 && cell == (stt + 1)) {
                    //$('#tkb tr:eq(28) td:eq(' + (cell - 1) + ')').html(thu4t9).attr('style','border: 1px solid #ddd;');
                     if(number.vipham==1)
                    {
                        $('#tkb tr:eq(28) td:eq(' + (cell-1) + ')').html(thu4t9).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t9.filter(function(number) {
                ...
                if (j == 38 && malop == lop5t9 && cell == (stt + 1)) {
                    //$('#tkb tr:eq(38) td:eq(' + (cell - 1) + ')').html(thu5t9).attr('style','border: 1px solid #ddd;');
                     if(number.vipham==1)
                    {
                        $('#tkb tr:eq(38) td:eq(' + (cell-1) + ')').html(thu5t9).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t9.filter(function(number) {
                ...
                if (j == 48 && malop == lop6t9 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(48) td:eq(' + (cell-1) + ')').html(thu6t9).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t9.filter(function(number) {
                ...
                if (j == 58 && malop == lop7t9 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(58) td:eq(' + (cell-1) + ')').html(thu7t9).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky2t10.filter(function(number) {
                ...
                if (j == 9 && malop == lop2t10 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(9) td:eq(' + (cell-1) + ')').html(thu2t10).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky3t10.filter(function(number) {
                ...
                if (j == 19 && malop == lop3t10 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(19) td:eq(' + (cell-1) + ')').html(thu3t10).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky4t10.filter(function(number) {
                ...
                if (j == 29 && malop == lop4t10 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(29) td:eq(' + (cell-1) + ')').html(thu4t10).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky5t10.filter(function(number) {
                ...
                if (j == 39 && malop == lop5t10 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(39) td:eq(' + (cell-1) + ')').html(thu5t10).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky6t10.filter(function(number) {
                ...
                if (j == 49 && malop == lop6t10 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(49) td:eq(' + (cell-1) + ')').html(thu6t10).attr('style','border: 1px solid #ddd;background-color: red');
            ...
            lucky7t10.filter(function(number) {
                ...
                if (j == 59 && malop == lop7t10 && cell == (stt + 1)) {
                    ...
                    if(number.vipham==1)
                    {
                        $('#tkb tr:eq(59) td:eq(' + (cell-1) + ')').html(thu7t10).attr('style','border: 1px solid #ddd;background-color: red');
    ...
    function handleDrop(e) {
        ...
        if (dragSrctkb != this) {
         ...
         var error=checktrungtiet(dragdata1,dragdata2);
            let loi='';
            if(error.first!=null)loi+='Trùng lịch giáo viên1:'+error.first.hovatengv+'-'+error.first.tenmon+'-'+error.first.tenlop+' ';
            if(error.second!=null)loi+='Trùng lịch giáo viên2:'+error.second.hovatengv+'-'+error.second.tenmon+'-'+error.second.tenlop+' ';
            loi+=error.main;
            Swal.fire({
                title: 'Thông báo',
                text: loi+"\br Bạn có muốn đổi tiết này không",
                icon: 'warning',
                ...
                if(result.value == true){
                    ...
                    hoandoitkb(dragdata1,dragdata2,dragSrctkbrow,dragSrctkbcol,thisdragSrctkbrow,thisdragSrctkbcol,datastkb);
                    showtkb(datatkb);
    ...
    function checktrungtiet(item1,item2)
    {
        const error = {};
          error.first=null;
          error.second=null;
        ...
        {
            //kiem tra trung lich
            if(item.id!=item2.id&&item.thu==item2.thu&&item.tiet==item2.tiet&&item.buoi==item2.buoi&&item.magiaovien==item1.magiaovien)
            {
                error.first=item;
            }
            if(item.id!=item1.id&&item.thu==item1.thu&&item.tiet==item1.tiet&&item.buoi==item1.buoi&&item.magiaovien==item2.magiaovien)
            {
                error.second=item;
            }
            //tiết không học hoặc tiết cố định ko cho đổic
            if(item1.tinhtrang==0||item2.tinhtrang==0)
            {
                error.main='Cảnh báo tiết không học, tiết cố định';
            }
            //cảnh báo trúng tiết nghỉ giáo viên
            //
        });
        return error;
    }
    function hoandoitkb(item1,item2)
    {
         //let it1 = datastkb.findIndex(item1 => item1.row == dragSrctkbrow&&item1.cell == dragSrctkbcol);
        //let it2 = datastkb.findIndex(item2 => item2.row == thisdragSrctkbrow&&item2.cell == thisdragSrctkbcol);

         let it1 = datatkb.findIndex((x) => x.id == item1[0].id);
         let it2 = datatkb.findIndex((x) => x.id == item2[0].id);

        const container = {};
        container.buoi = datastkb[it2].buoi;
        container.cell = datastkb[it2].cell;
        container.hovatengv = datastkb[it1].hovatengv;
        container.magiaovien = datastkb[it1].magiaovien;
        container.malop = datastkb[it2].malop;
        container.mamon = datastkb[it1].mamon;
        container.row = datastkb[it2].row;
        container.tenlop = datastkb[it2].tenlop;
        container.tenmon = datastkb[it1].tenmon;
        container.thu = datastkb[it2].thu;
        container.tiet = datastkb[it2].tiet;

        // thiet lap mang 1
        datastkb[it1].buoi=datastkb[it1].buoi;
        datastkb[it1].cell=datastkb[it1].cell;
        datastkb[it1].hovatengv=datastkb[it2].hovatengv;
        datastkb[it1].magiaovien=datastkb[it2].magiaovien;
        datastkb[it1].malop=datastkb[it1].malop;
        datastkb[it1].mamon=datastkb[it2].mamon;
        datastkb[it1].row=datastkb[it1].row;
        datastkb[it1].tenlop=datastkb[it1].tenlop;
        datastkb[it1].tenmon=datastkb[it2].tenmon;
        datastkb[it1].thu=datastkb[it1].thu;
        datastkb[it1].tiet=datastkb[it1].tiet;
        // trả lại cai trước
        datastkb[it2].buoi=container.buoi;
        datastkb[it2].cell=container.cell;
        datastkb[it2].hovatengv=container.hovatengv;
        datastkb[it2].magiaovien=container.magiaovien;
        datastkb[it2].malop=container.malop;
        datastkb[it2].mamon=container.mamon;
        datastkb[it2].row=container.row;
        datastkb[it2].tenlop=container.tenlop;
        datastkb[it2].tenmon=container.tenmon;
        datastkb[it2].thu=container.thu;
        datastkb[it2].tiet=container.tiet;
    ...
    var data = axios.get('getdanhsachphonghocbomon').then(function(response) {
        ...
        $("#girddsphonghoc").dxDataGrid({
            ...
            onSelectionChanged: function(selectedItems) {
                var data = selectedItems.selectedRowsData[0];
                idphonghoc = data.id;
                tenphonghoc = data.tenphong;

                if (datatkb != undefined) {
                    $('#titletkbphonghoc').html('Thời khóa biểu phòng học: ' + tenphonghoc);
                    document.getElementById("cardxeptkbphonghoc").style.display = "block";
                    let index = 0;

                    var tkbtemp = datatkb.filter(function(number) {
                        if (number.phonghoc == idphonghoc) {
                            return number;
                        }
                    });
                    var datas = tkbtemp;
                    ...
                    $('#tkbphonghoc tr:eq(0) td:eq(2)').html(thu2t1).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 1
                    var thu3t1 = [];
                    lucky3t1.filter(function(number) {
                        var mon3t1 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(0) td:eq(3)').html(thu3t1).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 1
                    var thu4t1 = [];
                    lucky4t1.filter(function(number) {
                        var mon4t1 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(0) td:eq(4)').html(thu4t1).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 1
                    var thu5t1 = [];
                    lucky5t1.filter(function(number) {
                        var mon5t1 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(0) td:eq(5)').html(thu5t1).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 1
                    var thu6t1 = [];
                    lucky6t1.filter(function(number) {
                        var mon6t1 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(0) td:eq(6)').html(thu6t1).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 1
                    var thu7t1 = [];
                    lucky7t1.filter(function(number) {
                        var mon7t1 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(0) td:eq(7)').html(thu7t1).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(1) td:eq(2)').html(thu2t2).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 2
                    var thu3t2 = [];
                    lucky3t2.filter(function(number) {
                        var mon3t2 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(1) td:eq(3)').html(thu3t2).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 2
                    var thu4t2 = [];
                    lucky4t2.filter(function(number) {
                        var mon4t2 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(1) td:eq(4)').html(thu4t2).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 2
                    var thu5t2 = [];
                    lucky5t2.filter(function(number) {
                        var mon5t2 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(1) td:eq(5)').html(thu5t2).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 2
                    var thu6t2 = [];
                    lucky6t2.filter(function(number) {
                        var mon6t2 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(1) td:eq(6)').html(thu6t2).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 2
                    var thu7t2 = [];
                    lucky7t2.filter(function(number) {
                        var mon7t2 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(1) td:eq(7)').html(thu7t2).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(2) td:eq(2)').html(thu2t3).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 3
                    var thu3t3 = [];
                    lucky3t3.filter(function(number) {
                        var mon3t3 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(2) td:eq(3)').html(thu3t3).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 3
                    var thu4t3 = [];
                    lucky4t3.filter(function(number) {
                        var mon4t3 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(2) td:eq(4)').html(thu4t3).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 3
                    var thu5t3 = [];
                    lucky5t3.filter(function(number) {
                        var mon5t3 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(2) td:eq(5)').html(thu5t3).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 3
                    var thu6t3 = [];
                    lucky6t3.filter(function(number) {
                        var mon6t3 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(2) td:eq(6)').html(thu6t3).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 3
                    var thu7t3 = [];
                    lucky7t3.filter(function(number) {
                        var mon7t3 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(2) td:eq(7)').html(thu7t3).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(3) td:eq(2)').html(thu2t4).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 4
                    var thu3t4 = [];
                    lucky3t4.filter(function(number) {
                        var mon3t4 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(3) td:eq(3)').html(thu3t4).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 4
                    var thu4t4 = [];
                    lucky4t4.filter(function(number) {
                        var mon4t4 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(3) td:eq(4)').html(thu4t4).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 4
                    var thu5t4 = [];
                    lucky5t4.filter(function(number) {
                        var mon5t4 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(3) td:eq(5)').html(thu5t4).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 4
                    var thu6t4 = [];
                    lucky6t4.filter(function(number) {
                        var mon6t4 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(3) td:eq(6)').html(thu6t4).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 4
                    var thu7t4 = [];
                    lucky7t4.filter(function(number) {
                        var mon7t4 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(3) td:eq(7)').html(thu7t4).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(4) td:eq(2)').html(thu2t5).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 5
                    var thu3t5 = [];
                    lucky3t5.filter(function(number) {
                        var mon3t5 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(4) td:eq(3)').html(thu3t5).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 5
                    var thu4t5 = [];
                    lucky4t5.filter(function(number) {
                        var mon4t5 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(4) td:eq(4)').html(thu4t5).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 5
                    var thu5t5 = [];
                    lucky5t5.filter(function(number) {
                        var mon5t5 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(4) td:eq(5)').html(thu5t5).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 5
                    var thu6t5 = [];
                    lucky6t5.filter(function(number) {
                        var mon6t5 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(4) td:eq(6)').html(thu6t5).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 5
                    var thu7t5 = [];
                    lucky7t5.filter(function(number) {
                        var mon7t5 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(4) td:eq(7)').html(thu7t5).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(5) td:eq(2)').html(thu2t6).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 2
                    var thu3t6 = [];
                    lucky3t6.filter(function(number) {
                        var mon3t6 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(5) td:eq(3)').html(thu3t6).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 2
                    var thu4t6 = [];
                    lucky4t6.filter(function(number) {
                        var mon4t6 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(5) td:eq(4)').html(thu4t6).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 2
                    var thu5t6 = [];
                    lucky5t6.filter(function(number) {
                        var mon5t6 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(5) td:eq(5)').html(thu5t6).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 2
                    var thu6t6 = [];
                    lucky6t6.filter(function(number) {
                        var mon6t6 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(5) td:eq(6)').html(thu6t6).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 2
                    var thu7t6 = [];
                    lucky7t6.filter(function(number) {
                        var mon7t6 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(5) td:eq(7)').html(thu7t6).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(6) td:eq(2)').html(thu2t7).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 2
                    var thu3t7 = [];
                    lucky3t7.filter(function(number) {
                        var mon3t7 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(6) td:eq(3)').html(thu3t7).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 2
                    var thu4t7 = [];
                    lucky4t7.filter(function(number) {
                        var mon4t7 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(6) td:eq(4)').html(thu4t7).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 2
                    var thu5t7 = [];
                    lucky5t7.filter(function(number) {
                        var mon5t7 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(6) td:eq(5)').html(thu5t7).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 2
                    var thu6t7 = [];
                    lucky6t7.filter(function(number) {
                        var mon6t7 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(6) td:eq(6)').html(thu6t7).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 2
                    var thu7t7 = [];
                    lucky7t7.filter(function(number) {
                        var mon7t7 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(6) td:eq(7)').html(thu7t7).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(7) td:eq(2)').html(thu2t8).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 2
                    var thu3t8 = [];
                    lucky3t8.filter(function(number) {
                        var mon3t8 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(7) td:eq(3)').html(thu3t8).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 2
                    var thu4t8 = [];
                    lucky4t8.filter(function(number) {
                        var mon4t8 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(7) td:eq(4)').html(thu4t8).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 2
                    var thu5t8 = [];
                    lucky5t8.filter(function(number) {
                        var mon5t8 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(7) td:eq(5)').html(thu5t8).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 2
                    var thu6t8 = [];
                    lucky6t8.filter(function(number) {
                        var mon6t8 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(7) td:eq(6)').html(thu6t8).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 2
                    var thu7t8 = [];
                    lucky7t8.filter(function(number) {
                        var mon7t8 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(7) td:eq(7)').html(thu7t8).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(8) td:eq(2)').html(thu2t9).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 2
                    var thu3t9 = [];
                    lucky3t9.filter(function(number) {
                        var mon3t9 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(8) td:eq(3)').html(thu3t9).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 2
                    var thu4t9 = [];
                    lucky4t9.filter(function(number) {
                        var mon4t9 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(8) td:eq(4)').html(thu4t9).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 2
                    var thu5t9 = [];
                    lucky5t9.filter(function(number) {
                        var mon5t9 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(8) td:eq(5)').html(thu5t9).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 2
                    var thu6t9 = [];
                    lucky6t9.filter(function(number) {
                        var mon6t9 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(8) td:eq(6)').html(thu6t9).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 2
                    var thu7t9 = [];
                    lucky7t9.filter(function(number) {
                        var mon7t9 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(8) td:eq(7)').html(thu7t9).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    ...
                    $('#tkbphonghoc tr:eq(9) td:eq(2)').html(thu2t10).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t3 tiet 2
                    var thu3t10 = [];
                    lucky3t10.filter(function(number) {
                        var mon3t10 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(9) td:eq(3)').html(thu3t10).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t4 tiet 2
                    var thu4t10 = [];
                    lucky4t10.filter(function(number) {
                        var mon4t10 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(9) td:eq(4)').html(thu4t10).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t5 tiet 2
                    var thu5t10 = [];
                    lucky5t10.filter(function(number) {
                        var mon5t10 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(9) td:eq(5)').html(thu5t10).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t6 tiet 2
                    var thu6t10 = [];
                    lucky6t10.filter(function(number) {
                        var mon6t10 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(9) td:eq(6)').html(thu6t10).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');
                    //t7 tiet 2
                    var thu7t10 = [];
                    lucky7t10.filter(function(number) {
                        var mon7t10 = number.tenmon;
                    ...
                    $('#tkbphonghoc tr:eq(9) td:eq(7)').html(thu7t10).attr('style', 'border: 1px solid #ddd;white-space: nowrap;');




                    var tablegv = $('#example4').DataTable({
                        "bPaginate": false,
                        "bLengthChange": false,
                        "bFilter": true,
                        "bInfo": false,
