...
function initControl() {
    ...
    timkiemHolot = document.getElementById("timkiemHolot");
...
function initEvent() {
    timkiemHolot.oninput = function (e) {
        Search("tdHolot", timkiemHolot);
    };
    ...
    btnTaipccm.onclick = function (e) {
        xuatBangphancong().then((res) => {
            window.open(`${public_path}download/${res}`);
        });
    };
...
function hienthiDanhsach(danhsach) {
    ...
    danhsach.forEach((item) => {
        ...
        let holot = creatTd(item.holot, null, "tdHolot");
        let ten = creatTd(item.ten, null, "tdTen");
        ...
        buttonPCCM.setAttribute("class", "btn btn-sm btn-primary");
                        ...
                        danhsachLop.forEach((item) => {
                            ...
                            inputChon.onclick = function (e) {
                                ...
                                if (inputChon.checked) {
                                    ...
                                    giaovien.textContent = `${ttgiaovien.holot} ${ttgiaovien.ten}`;
                                    sotietchuaphancong.textContent = "";
